    ...
    def preorderTraversal(self, root):
        ...
        while stack:
            ...
            if curr_node:
                ...
                # note that we add curr_node's left child to the stack first
                # answer: [node, right, left]
                stack.append(curr_node.left)
                stack.append(curr_node.right)


        # return reversed answer after we empty stack
        # answer: [node, right, left] => reversed answer: [left, right, node]
        return answer[::-1]
